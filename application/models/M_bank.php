...
{
   var $table = 'tbl_bank';
   var $colum_order = array('id_bank', 'nama_bank');
   var $order = array('id_bank', 'nama_bank');
   ...
   private function _get_data_query()
   {
      ...
      if (isset($_POST['search']['value'])) {
         $this->db->like('nama_bank', $_POST['search']['value']);
   ...
   {
      return $this->db->get_where($this->table, ['id_bank' => $id_bank])->row();
   }
   ...
   {
      $this->db->delete($this->table, ['id_bank' => $id_bank]);
      return $this->db->affected_rows();
   }
